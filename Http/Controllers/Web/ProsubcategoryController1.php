...
class ProsubcategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $subcategories = Subcategory::select(['id','name','slug','subcategory_id'])->where('status',1)->get();
    ...
    public function edit($id)
    {
        ...
        if($user_id){
            ...
            return view('backend.admin.prosubcategory.edit', compact('subcategories', 'categories', 'prosubcategory'));
        }else{
            return redirect('login');
        }        
